      ...
      <form action='search.php' method='post'>
        ...
        <div class="inner-form">
          ...
          <div class="input-field second-wrap">
            ...
            <input class="datepicker" id="depart" name='start_date' type="text" placeholder="15 March 2020" />
          </div>
          <div class="input-field third-wrap">
            ...
            <input class="datepicker" id="return" name='end_date' type="text" placeholder="18 March 2020" />
          </div>
